...
const DICT = new Map([
  ...
  ['政策解説シミュレーター', 'Policy Explainer Simulator'],
  ...
  ['日本の政策テーマを、解説・グラフ・シミュレーターで確認できるWebプロジェクトです。', 'A web project for exploring Japanese policy topics through explanations, charts, and simulators.'],
